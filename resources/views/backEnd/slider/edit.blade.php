                                ...
                                <form action="{{ route('slider.update', $slider->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        @error('judul_slider')
                                          is_invalid
                                        @enderror"
                                            id="text" placeholder="Masukan Judul Slider Vidio"
                                            value="{{ $slider->judul_slider }}" autofocus>
                                        @error('judul_slider')
                                    ...
                                    <div class="form-group">
                                        ...
                                        @error('link')
                                          is_invalid
                                        @enderror"
                                            placeholder="Mansukan Kategori" value="{{ $slider->link }}">
                                        @error('link')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{ asset('uploads/' . $slider->gambar_slider) }}" width="100">
                                        @error('gambar_slider')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @enderror"
                                            ...
                                            <option value="1" {{ $slider->status == '1' ? 'selected' : '' }}>
                                                Publish</option>
                                            <option value="0" {{ $slider->status == '0' ? 'selected' : '' }}>Draft
                                            </option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">
